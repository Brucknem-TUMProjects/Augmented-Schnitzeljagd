...
public class PlayerLocationService : MonoBehaviour
{
    ...
    public IEnumerator _StartLocationService()
    {
        ...
        if (!Input.location.isEnabledByUser)
        {
            ...
            loc.setLatLon_deg(48.262576f, 11.667882f);
        ...
        // break here for debugging purposes
    ...
    public IEnumerator RunLocationService()
    {
        ...
        while (true)
        {
            GameData.Instance.Me.Position.Latitude = loc.lat_d;
            GameData.Instance.Me.Position.Longitude = loc.lon_d;
